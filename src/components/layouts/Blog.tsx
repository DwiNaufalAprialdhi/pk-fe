      ...
      return (
            <>
                  <main className='w-full h-auto py-[50px] bg-slate-100 overflow-hidden'>
                        <section className='container_section flex flex-col gap-y-[14px] mb-[50px]'>
                              <div data-aos='fade-up' className='flex items-center justify-between'>
                                    <h2 className='font-quicksand font-bold lg:text-[24px] text-base lg:leading-[30px] leading-normal w-full lg:max-w-[70%] max-w-[80%]'>Karya Terbaik Kami untuk Setiap Klien</h2>
                        ...
                        <section className='container_section flex flex-col gap-y-[14px]'>
                              <div data-aos='fade-up' className='flex items-center justify-between'>
                                    <h2 className='font-quicksand font-bold lg:text-[24px] text-base lg:leading-[30px] leading-normal w-full lg:max-w-[70%] max-w-[80%]'>Tingkatkan Bisnis Anda dengan Landingpage dan Website Anda Sendiri</h2>
                                    <Link href='/' className='font-normal lg:text-base text-[10px] text-slate-400 hover:underline'>
                                          Lihat Semua
                                    </Link>
                              </div>
