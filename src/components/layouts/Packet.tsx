                  ...
                  <main className='w-full h-auto relative overflow-hidden'>
                        ...
                        <section className='container_section lg:py-[146px] py-[50px] lg:pb-[190px] pb-[50px] relative z-[2]'>
                              ...
                              <div data-aos='fade-up' className='w-full flex items-center justify-center gap-[14px] mb-[50px]'>
                                    ...
                                    <Link href={'#'} type='button' className={`w-full max-w-[224px] lg:p-[15px] p-3 flex items-center justify-center gap-2 bg-transparent rounded-[8px] hover:bg-opacity-80 duration-300 group`}>
                                          <h2 className='font-semibold lg:text-sm text-xs text-slate-50'>Lihat Paket Lainnya</h2>
                                          <Icon.arrowRight className='w-6 h-6 text-slate-50 group-hover:translate-x-1 duration-300' />
                                    </Link>
                              </div>
                              {/* Cards */}
                              <div className='w-full grid lg:grid-cols-3 grid-cols-1 items-center justify-center gap-[24px]'>
                                    {/* Card Started */}
                                    <Link data-aos='fade-right' href={'#'} className='w-full col-span-1 bg-white h-auto lg:p-[30px] p-5 rounded-[16px] flex flex-col group hover:bg-theme-primary_blue duration-300 hover:border hover:border-white border border-white relative overflow-hidden'>
                                          {/* Layer */}
                                    ...
                                    {/* Card Standar */}
                                    <Link data-aos='fade-up' href={'#'} className='w-full col-span-1 bg-white h-auto lg:p-[30px] lg:pb-[150px] p-5 rounded-[16px] flex flex-col group hover:bg-theme-primary_blue duration-300 hover:border hover:border-white border border-white relative overflow-hidden'>
                                          {/* Layer */}
                                          <div className='absolute top-0 inset-x-0 w-full h-full opacity-0 group-hover:opacity-100 duration-500 bg-gradient-to-b from-theme-primary_blue via-theme-primary_blue to-text-dark z-[1]'></div>
                                          <div className='flex flex-col relative z-[2]'>
                                                {/* Badge */}
                                    ...
                                    {/* Card Professional */}
                                    <Link data-aos='fade-left' href={'#'} className='w-full col-span-1 bg-white h-auto lg:p-[30px] p-5 rounded-[16px] flex flex-col group hover:bg-theme-primary_blue duration-300 hover:border hover:border-white border border-white relative overflow-hidden'>
                                          {/* Layer */}
                                          <div className='absolute top-0 inset-x-0 w-full h-full opacity-0 group-hover:opacity-100 duration-500 bg-gradient-to-b from-theme-primary_blue via-theme-primary_blue to-text-dark z-[1]'></div>
                                          <div className='flex flex-col relative z-[2]'>
                                                {/* Badge */}
